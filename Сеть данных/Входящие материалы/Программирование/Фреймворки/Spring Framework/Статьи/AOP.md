...
Типы Advice:
- **Before** ([[Сеть данных/Входящие материалы/Программирование/Фреймворки/Spring Framework/Bases/Spring аннотации/mini/@Before]]) - выполняется до метода с основной логикой.
