...
*status:* Ready
*format:* stage
*tegs:* #design #dataStruct #programming #java #python #spring 
...
Приведем еще один пример, как можно использовать программирование на урвоне интерфейса. Мы используем [[$ Pattern Fabrica]]:
